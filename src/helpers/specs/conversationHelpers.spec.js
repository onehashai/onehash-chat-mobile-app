...
describe('extractConversationIdFromUrl', () => {
  it('should return conversation if valid url is passed', () => {
    expect(
      extractConversationIdFromUrl({
        url: 'https://chat.onehash.ai/app/accounts/1/conversations/23919',
      }),
    ).toBe(23919);
  });
  ...
  it('should return conversation if folder conversation url is passed', () => {
    expect(
      extractConversationIdFromUrl({
        url: 'https://chat.onehash.ai/app/accounts/1/custom_view/338/conversations/26511',
      }),
    ).toBe(26511);
  });
  ...
  it('should return conversation if mention conversation url is passed', () => {
    expect(
      extractConversationIdFromUrl({
        url: 'https://chat.onehash.ai/app/accounts/1/mentions/conversations/21480',
      }),
    ).toBe(21480);
  });
  ...
  it('should return null if invalid url is passed', () => {
    expect(
      extractConversationIdFromUrl({
        url: 'https://chat.onehash.ai/app/accounts/1/conversations/',
      }),
    ).toBe(null);
  });
